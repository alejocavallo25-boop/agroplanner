...
<head>
    ...
    <style>
        ...
        #loading-overlay {
            ...
            /* Era un velo casi negro, del tema oscuro anterior. Sobre el tema
               claro el texto de "Cargando" queda ilegible contra eso: el velo
               tiene que ser del color de la página, no su opuesto. */
            background: oklch(0.968 0.006 150 / 0.92);
        ...
        /* Era un esmeralda suelto (#34d399) del tema viejo: sobre fondo claro
           casi no se veía. Ahora es el escalón claro de la misma rampa verde. */
        .grass-blade.light { stroke: var(--g-500); }
